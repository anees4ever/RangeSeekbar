...
public class RangeSeekBar<T extends Number> extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            try {
                ...
                String sMinLabel = getResources().getString(R.string.demo_min_label);
                String sMaxLabel = getResources().getString(R.string.demo_max_label);
                minLabel = a.hasValue(R.styleable.RangeSeekBar_minLabel)?a.getString(R.styleable.RangeSeekBar_minLabel):sMinLabel;
                maxLabel = a.hasValue(R.styleable.RangeSeekBar_maxLabel)?a.getString(R.styleable.RangeSeekBar_maxLabel):sMaxLabel;
                ...
                defaultColor = a.getColor(R.styleable.RangeSeekBar_defaultColor, Color.BLACK);
    ...
    public interface CustomFormat<T> {
        String onCustomFormat(Float value);
    }
    private CustomFormat mCustomFormat;
    public void setCustomValueFormat(CustomFormat customFormat) {
        mCustomFormat= customFormat;
    }

    protected String valueToString(T value) {
        return mCustomFormat!=null?mCustomFormat.onCustomFormat((Float)value):String.format("%.2f", (Float)value);
    }
